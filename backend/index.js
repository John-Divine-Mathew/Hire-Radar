...
app.post("/hireRadar/managerrequest", async (req, res) => {
    try {
        ...
        // Parse types cleanly for PostgreSQL integer and date types
        const parsedOpenings = openings ? parseInt(openings, 10) : 1;
        const managerIdVal = managerid ? parseInt(managerid, 10) : null;
        
        // Ensure empty strings convert to null for integer columns
        const minSalary = (salarymin !== "" && salarymin !== null && !isNaN(salarymin)) 
            ? parseInt(salarymin, 10) 
            : null;

        const maxSalary = (salarymax !== "" && salarymax !== null && !isNaN(salarymax)) 
        ...
        const queryValues = [
            managerIdVal,                        // $1  - managerid
            managerName || null,                 // $2  - manager_name
            managerEmail || null,                // $3  - manager_email
            department || null,                  // $4  - department
            jobTitle || null,                    // $5  - job_title
            targetDepartment || null,            // $6  - target_department
            employmentType || 'Full Time',       // $7  - employment_type
            experience || null,                  // $8  - experience
            parsedOpenings,                      // $9  - vacancies
            parsedOpenings,                      // $10 - openings
            location || null,                    // $11 - location
            targetJoiningDate,                   // $12 - joining_date
            jobPriority || 'Medium',             // $13 - priority
            skills || null,                      // $14 - skills
            responsibilities || null,            // $15 - jobdescription
            education || null,                   // $16 - education
            minimumpercentage || null,           // $17 - minimumpercentage
            minSalary,                           // $18 - salary_min
            maxSalary,                           // $19 - salary_max
            interviewprocess || null,            // $20 - interviewprocess
            remarks || null,                     // $21 - remarks
            'Pending'                            // $22 - status
        ];
