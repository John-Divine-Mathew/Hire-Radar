...
const COLORS = ["#5B3DF5", "#7C5CFF", "#F4C542", "#33b67b", "#8B8B8B"];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              <button className="px-4 py-2 bg-white border rounded-md text-sm text-gray-700 shadow-sm">
                Export
              </button>
              <button className="px-4 py-2 bg-violet-600 text-white rounded-md text-sm shadow hover:bg-violet-700">
                New Report
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            {stats.map((s) => (
              <div key={s.label} className="bg-white p-5 rounded-lg shadow border">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            <section className="lg:col-span-8 bg-white p-6 rounded-lg shadow border">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-800">Search Trends</h2>
              ...
              <div style={{ height: 320 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={trendData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                    ...
                    <Tooltip />
                    <Line type="monotone" dataKey="value" stroke="#5B3DF5" strokeWidth={3} dot={{ r: 3 }} activeDot={{ r: 6 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </section>

            <aside className="lg:col-span-4 bg-white p-6 rounded-lg shadow border">
              <div className="flex items-center justify-between mb-4">
