...
const StatCard = ({ icon: Icon, label, value, change, color }) => (
  <div className="bg-white rounded-xl p-5 shadow-sm border border-t-4" style={{ borderTopColor: color }}>
    <div className="flex items-center justify-between">
      <div>
        <p className="text-[#64748B] font-medium text-sm uppercase tracking-wider">{label}</p>
