...
function Sidebar(){
    ...
    const navigateFilterCandidates = ()=>{
        nav('/filterCandidates');
    }
            ...
            <div className='sidebarPanel'>
                <ul className="sidebarlist">
                   {/* <li><button className='listitem' onClick={navigateDashboard} title="Dashboard" aria-label="Dashboard"><House size={iconSize} /><p className='buttonP'>Dashboard</p></button></li> */}
                    ...
                    <li><button className='listitem' onClick={navigateSavedCandidates} title="Saved Candidates" aria-label="Saved Candidates"><Bookmark size={iconSize} /><p className='buttonP'>Uploaded Candidates</p></button></li>
                          <li><button className='listitem' onClick={navigateFilterCandidates} title="Filter Candidates" aria-label="Filter Candidates"><Search size={iconSize} /><p className='buttonP'>Filter Candidates</p></button></li>
